 ...
 */
final class Version20220803161857 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_profile ADD CONSTRAINT FK_D95AB40526EBDC83 FOREIGN KEY (foregin_user_id_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
